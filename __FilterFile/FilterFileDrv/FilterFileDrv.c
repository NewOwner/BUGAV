...
DriverEntry(
    ...
    DbgPrint("############################### FilterFileDrv!DriverEntry: Entered ###############################\n");
...
NTSTATUS PtUnload(_In_ FLT_FILTER_UNLOAD_FLAGS Flags) {
    ...
    DbgPrint("### FilterFileDrv!FltCloseCommunicationPort\n");

    FltUnregisterFilter(PassThroughData.Filter);
    DbgPrint("### FilterFileDrv!FltUnregisterFilter\n");
...
PtOperationStatusCallback(
    ...
    DbgPrint("############################### FilterFileDrv!PtOperationStatusCallback: Entered ###############################\n");

    DbgPrint("############################### FilterFileDrv!PtOperationStatusCallback: Status=%08x ctx=%p IrpMj=%02x.%02x \"%s\" ###############################\n",
        OperationStatus,
        RequesterContext,
...
PtPreOperationNoPostOperationPassThrough(
    ...
    DbgPrint("############################### FilterFileDrv!PtPreOperationNoPostOperationPassThrough: Entered ###############################\n");
