...
BOOL DriverCtrl::UtilLoadDriver(
...
BOOL DriverCtrl::UtilUnloadDriver(
    _In_ HANDLE hDriver,
...
BOOL DriverCtrl::UtilGetServiceState(
...
BOOL DriverCtrl::UtilWaitForServiceState(
    _In_ SC_HANDLE hService,
    _In_ DWORD State
)
/*++
...
BOOL DriverCtrl::UtilCreateService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName,
...
BOOL DriverCtrl::UtilStartService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
BOOL DriverCtrl::UtilStopService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
BOOL DriverCtrl::UtilDeleteService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
BOOL DriverCtrl::UtilOpenDevice(
    _In_ LPTSTR szWin32DeviceName,
