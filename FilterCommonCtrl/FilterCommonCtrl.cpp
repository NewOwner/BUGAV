#include "pch.h"
#include "framework.h"
#include "FilterCommonCtrl.h"

FilterCommonCtrl::FilterCommonCtrl() {
}

FilterCommonCtrl::~FilterCommonCtrl() {
}

BOOL FilterCommonCtrl::UtilLoadDriver(
...
BOOL FilterCommonCtrl::UtilUnloadDriver(
    _In_ HANDLE hDriver,
...
BOOL FilterCommonCtrl::UtilGetServiceState(
...
BOOL FilterCommonCtrl::UtilWaitForServiceState(
    _In_ SC_HANDLE hService,
    _In_ DWORD State
)
/*++
...
BOOL FilterCommonCtrl::UtilCreateService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName,
...
BOOL FilterCommonCtrl::UtilStartService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
--*/
{
    ...
    if (FALSE == UtilWaitForServiceState(hService, SERVICE_RUNNING)) { goto Exit; }
...
BOOL FilterCommonCtrl::UtilStopService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
BOOL FilterCommonCtrl::UtilDeleteService(
    _In_ SC_HANDLE hSCM,
    _In_ LPTSTR szDriverName
)
/*++
...
BOOL FilterCommonCtrl::UtilOpenDevice(
    _In_ LPTSTR szWin32DeviceName,
