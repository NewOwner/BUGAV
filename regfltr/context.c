    ...
    switch(NotifyClass) {
        ...
        case RegNtPostOpenKeyEx:
            ...
            if (NT_SUCCESS(PostInfo->Status)) {
                ...
                if (!NT_SUCCESS(Status)) {
                    DbgPrint("REGFLTR ### CmSetCallbackobjectContext failed. Status 0x%x\n",
                               Status);
                }
            }
            break;
        ...
        case RegNtPostSetValueKey:
            ...
            if (ObjectContext == NULL) {
                ...
                DbgPrint("REGFLTR ### Unexpected ObjectContext value: 0x%p\n", ObjectContext);
            }
        ...
        case RegNtCallbackObjectContextCleanup:
            ...
            if (CleanupInfo->ObjectContext != CallbackCtx) {
                DbgPrint("REGFLTR ### ContextCleanup's ObjectContext has unexpected value: 0x%p.\n",
    ...
    switch(NotifyClass) {
        ...
        case RegNtPostCreateKeyEx:
            ...
            if (PostInfo->CallContext != CallbackCtx) {
                DbgPrint("REGFLTR ### Unexpected CallContext value: 0x%p\n", PostInfo->CallContext);
            } else {
                InterlockedIncrement(&CallbackCtx->NotificationWithContextCount);
            }
            break;
