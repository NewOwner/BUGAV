...
SetupDriverNameBasic(
    ...
    if (FAILED(StringCbCat(DriverLocation, BufferLength, TEXT("\\" DRIVER_NAME_BASIC ".sys")))) {
        return FALSE;
    }
...
SetupDriverNameWeb(
    ...
    if (FAILED(StringCbCat(DriverLocation, BufferLength, TEXT("\\" DRIVER_NAME_WEB ".sys")))) {
        return FALSE;
    }
